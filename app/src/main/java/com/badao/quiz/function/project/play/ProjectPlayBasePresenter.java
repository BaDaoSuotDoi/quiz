...
public class ProjectPlayBasePresenter extends BasePresenter<ProjectPlayBaseContract.View> implements ProjectPlayBaseContract.Presenter{
    public ProjectPlayBasePresenter(Context context) {
        super(context);
    }
